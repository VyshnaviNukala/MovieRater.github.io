...
const searchInput = document.getElementById("searchInput"); // Corrected selector
const searchButton = document.getElementById("searchButton"); // Corrected selector
...
function displayMovies(movies) {
  ...
  movies.forEach((movie) => {
    ...
    movieRating.classList.add("movie-info");
